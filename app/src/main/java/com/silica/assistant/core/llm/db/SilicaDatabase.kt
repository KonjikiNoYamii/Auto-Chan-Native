...
@Database(entities = [ChatMessageEntity::class, UserFactEntity::class, UserProfileEntity::class, QuestEntity::class, AchievementEntity::class, FriendEntity::class, SocialMessageEntity::class], version = 14, exportSchema = false)
