...
@Database(entities = [ChatMessageEntity::class, UserFactEntity::class, UserProfileEntity::class, QuestEntity::class, AchievementEntity::class], version = 10, exportSchema = false)
